...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata('worldbank4.csv', keepcolumns, valuevariables)
    df_two = cleandata('worldbank2.csv', keepcolumns, valuevariables)
    ...
    graph_five = []
    df_five = cleandata('worldbank4.csv', ['Country Name', '2015'], ['2015'])
